...
func (c *CustomerUsecase) GetCustomer(ctx context.Context, id string) (*entity.Customer, error) {
...
//}
//
//func (c *CustomerUsecase) PostToWordpressNotYet(ctx context.Context, customerID string) error {
//	customer, err := c.customerService.GetCustomer(ctx, customerID)
//	if err != nil {
//		return err
//	}
...
//}
//
//func (c *CustomerUsecase) LinkInstagramToWordpress(ctx context.Context, customerID string) error {
//
//}
